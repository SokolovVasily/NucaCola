package com.vasily_sokolov.nucacola.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.vasily_sokolov.nucacola.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.vasily_sokolov.nucacola.service.*.*(..))")
